...
public class OrderService {
    ...
    // Use the class-level DATE_FORMAT constant for consistency
    ...
    public List<Order> getOrderFromDateToDateyyyyMMdd(Long startDate, Long endDate) throws ParseException {
        // Set the timezone to UTC using the class-level DATE_FORMAT
        DATE_FORMAT.setTimeZone(TimeZone.getTimeZone("UTC"));

        // Convert Long to Date using the DATE_FORMAT
