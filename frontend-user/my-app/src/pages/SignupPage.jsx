    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-500">
      <div className="bg-gray-900 text-white p-8 rounded-xl shadow-lg w-full max-w-md">
        ...
        <div className="flex justify-center mb-4">
          <img src="icon.png" alt="Chess_Player" className="h-6" />
        </div>

        {/* Title */}
        <h2 className="text-2xl font-bold text-center">Create your ChessPlayer account</h2>
        ...
        <button className="w-full bg-gray-800 text-white p-3 rounded-lg flex items-center justify-center gap-2 mt-2 hover:bg-gray-700">
          <img src="/apple-logo.png" alt="Apple" className="h-5" />
          Continue with Apple
        </button>
